const  XBOT = 'kanzbot'; // Nama Bot Whatsapp
const instagram = 'Gada'; // Nama Instagramlu cok
const nomer = 'https://Wa.me/+6282252452100'; // Nomor whatsapplu cok
const aktif = '24Jam'; // Kapan bot lu aktif
...
const vcard = 'BEGIN:VCARD\n' // metadata of the contact card
            ...
            + 'TEL;type=CELL;type=VOICE;waid=6282252452100:+62 821-4850-5737\n' // WhatsApp ID + phone number
            + 'END:VCARD'
